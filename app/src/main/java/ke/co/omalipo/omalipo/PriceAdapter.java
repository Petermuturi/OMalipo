...
public class PriceAdapter extends RecyclerView.Adapter<PriceAdapter.MyViewHolder> {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View v) {
            ...
            mTextView = (TextView) v.findViewById(R.id.details);
        }
    }

    // Provide a suitable constructor (depends on the kind of dataset)
    public PriceAdapter(String[] myDataset) {
        mDataset = myDataset;
    }

    // Create new views (invoked by the layout manager)
    @Override
    public PriceAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                     int viewType) {
        // create a new view
